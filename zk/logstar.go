...
func LogstarProve(hash hash.Hash, curve elliptic.Curve, Aux *pedersen.Parameters, PK *paillier.PublicKey, K *paillier.Ciphertext, Xx *big.Int, Xy *big.Int, k *saferith.Int, rho *saferith.Nat) *Logstarp {
	N := PK.N()
	NModulus := PK.Modulus()
